...
import classes from "./GallerySampleProp.module.css";
import { useNavigate } from "react-router-dom";
import logo from '../../../assets/Logos/logo.svg'

interface GallerySamplePropProps {
...
const GallerySampleProp: React.FC<GallerySamplePropProps> = ({ images, title, navigationRef, bgColor}) => {
...
export default GallerySampleProp;